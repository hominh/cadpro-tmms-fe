...
export default function Camera() {
	...
	const [showToastAddCameraSucess, setShowToastAddCameraSuccess] = useState(false);
	const [showToastDeleteCameraSuccess, setShowToastDeleteCameraSuccess] = useState(false);
		...
		<>
			{showToastAddCameraSucess && (
				...
				>
					...
					<Toast.Toggle onDismiss={() => setShowToastAddCameraSuccess(false)} />
				</Toast>
			)}
			{showToastDeleteCameraSuccess && (
				<Toast
					theme={{
						root: {
							base: 'absolute top-20 left-1/2 transform -translate-x-1/2 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400'
				...
				>
					...
					<Toast.Toggle onDismiss={() => setShowToastDeleteCameraSuccess(false)} />
				</Toast>
			)}
			<div>
				<HR className="my-0" />
					...
					<div className="flex flex-col">
						...
						<div className="mt-5 flex justify-center items-center">
							<div className="flex flex-row gap-4">
								<div>
									<Button onClick={e => deleteCamera()} size="xs" color="failure">Xóa</Button>
								</div>
								<div>
