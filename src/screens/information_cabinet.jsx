...
export default function InformationCabinet() {
  const [currentPage, setCurrentPage] = useState(1);
  const onPageChange = (page) => setCurrentPage(page);
  const [showFormAddInformationCabinet, setShowFormAddInformationCabinet] = useState(false);
  const handleCloseFormAddInformationCabinet = () => setShowFormAddInformationCabinet(false);
  const onShowFormAddInformationCabinet = () => setShowFormAddInformationCabinet(true);
  const [showToastAddInformationCabinetSucess, setShowToastAddInformationCabinetSuccess] = useState(false);
  const [showToastDeleteInformationCabinetSuccess, setShowToastDeleteInformationCabinetSuccess] = useState(false);
  const [openModalDeleteInformationCabinet, setOpenModalDeleteInformationCabinet] = useState(false);
  const [classNameDrawer, setClassNameDrawer] = useState('');

  const [showDataTable, setShowDataTable] = useState(true);

  const addInformationCabinet = () => {
		setShowFormAddInformationCabinet(false);
		setShowToastAddInformationCabinetSuccess((state) => !state);
	};

  const deleteInformationCabinet = () => {
		setOpenModalDeleteInformationCabinet(false);
		setShowToastDeleteInformationCabinetSuccess((state) => !state);
	};
  ...
  return (
    <>
      {showToastAddInformationCabinetSucess && (
				<Toast
					theme={{
						root: {
				...
				>
					...
					<div className="ml-3 text-sm font-normal">Đã thêm tủ thông tin</div>
					<Toast.Toggle onDismiss={() => setShowToastAddInformationCabinetSuccess(false)} />
				</Toast>
			)}
			{showToastDeleteInformationCabinetSuccess && (
				<Toast
					theme={{
						root: {
							base: 'absolute top-20 left-1/2 transform -translate-x-1/2 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400'
				...
				>
					...
					<div className="ml-3 text-sm font-normal">Đã xóa tủ thông tin</div>
					<Toast.Toggle onDismiss={() => setShowToastDeleteInformationCabinetSuccess(false)} />
				</Toast>
			)}
      <div>
        <HR className="my-0" />
      ...
      <Modal
				...
				size="md" dismissible show={openModalDeleteInformationCabinet} onClose={() => setOpenModalDeleteInformationCabinet(false)}>
				<Modal.Header />
				<Modal.Body>
					<div className="flex flex-col">
						...
						<div className="flex justify-center items-center mt-4 text-base font-normal text-gray-500">
							Bạn có muốn xóa tủ thông tin này?
						</div>
						...
						<div className="mt-5 flex justify-center items-center">
							<div className="flex flex-row gap-4">
								<div>
									<Button onClick={e => deleteInformationCabinet()} size="xs" color="failure">Xóa</Button>
								</div>
								<div>
									<Button onClick={e => setOpenModalDeleteInformationCabinet(false)} size="xs" color="light">Không xóa</Button>
								</div>
							</div>
						</div>
					</div>
			...
			<Drawer
				className="md:h-full"
				backdrop={true}
				open={showFormAddInformationCabinet}
				onClose={handleCloseFormAddInformationCabinet}
				position="right"
				theme={{
					root: {
			...
			>
				<div className="flex flex-row gap-1 pl-4 pr-4">
					<div>
						<Drawer.Header title="Thêm tủ thông tin" />
					</div>
				</div>
								...
								<div className="mb-20">
									<div className="mt-4">
										<div className="flex flex-row gap-2.5">
											<div>
												<Button
													onClick={e => addInformationCabinet()}
													theme={{
														size: {
											...
											<div>
												<Button
                          onClick={() => setShowFormAddInformationCabinet(false)}
													theme={{
														size: {
															sm: 'px-3 py-2 text-sm'
														}
      ...
      <section className="pb-3 h-full">
        <div className="grid grid-cols-1 h-full md:grid-cols-12">
          <div className="pt-3 block md:col-span-2 pl-2">
            <SidebarSettings activeItem="information_cabinet_item" />
          </div>
          <div className="pl-4  block md:col-span-10 h-full bg-gray-100 pb-2">
            <div className="h-full flex flex-col pr-4">
              <div className="grid grid-cols-1 md:grid-cols-2 pb-4">
                <div className="	text-sl font-semibold pt-4">Tủ thông tin</div>
                <div className="pt-2 md:justify-self-end">
                  <Button
                    onClick={e => onShowFormAddInformationCabinet()}
                    theme={{
                ...
                <div className="flex flex-col h-full">
                  <div className="md:w-96 grid grid-cols-1 md:pl-4 md:pr-4">
                    <TextInput
                      ...
                      id="plate" type="text" icon={IoSearchOutline} placeholder="Tìm tủ thông tin" sizing="sm" required />
                  </div>
                  {showDataTable ? (
                    <>
                            ...
                            <Table.Row>
                              ...
                              <Table.Cell className="sticky right-0 whitespace-nowrap bg-white">
                                <div className="flex flex-row gap-6">
                                  ...
                                  <div>
                                    <Button size="sm"
                                      onClick={e => setOpenModalDeleteInformationCabinet(true)}
                                      color="red"
                                      theme={{
                                        color: {
